...
Application : mysteryshop
Subdomain   : https://mysteryshop.harold-datascience.co.ke
App root    : apps/mysteryshop
Document root: apps/mysteryshop/public      <- separate, holds no source
Target      : Python 3.11
...
os.environ.setdefault("SITE_DOMAIN", "mysteryshop.harold-datascience.co.ke")
os.environ.setdefault("SITE_SCHEME", "https")
os.environ.setdefault("SITE_NAME", "Mysteryshop")
